  ...
  return (
    <footer className="bg-slate-950 text-slate-300 py-24 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-12">
        ...
        <div className="md:col-span-1 space-y-6">
            ...
            <p className="text-slate-500 leading-relaxed text-sm">
                Empowering Indian families to create beautiful, dignified matrimonial profiles with privacy and ease.
            </p>
        ...
        {/* Links Column 1 */}
        <div>
            <h3 className="text-white font-bold mb-6 tracking-wide uppercase text-xs">Product</h3>
        ...
        {/* CTA Column */}
        <div>
            <h3 className="text-white font-bold mb-6 tracking-wide uppercase text-xs">Contact</h3>
      ...
      <div className="max-w-7xl mx-auto px-6 mt-20 pt-8 border-t border-slate-900 flex flex-col md:flex-row justify-between items-center text-xs text-slate-600">
          <p>© 2024 WedScribe. All rights reserved.</p>
