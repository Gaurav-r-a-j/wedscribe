...
export const PlaceholderImage = ({ className = "" }: { className?: string }) => (
  <div className={`bg-[#f3f4f6] flex items-center justify-center text-[#d1d5db] ${className}`}>
    <User size="40%" />
  </div>
);

export const SectionTitle = ({ title, className = "", lineClass = "bg-[#e5e7eb]" }: { title: string, className?: string, lineClass?: string }) => (
...
export const QuickFacts = ({ personal, education }: any) => (
    <div className="space-y-1 text-sm">
        <p className="text-[10px] uppercase tracking-[0.2em] font-semibold text-[#64748b]">Highlights</p>
